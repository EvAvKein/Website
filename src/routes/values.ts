...
const values:[valueName, string][] = [
  ...
  ["Discipline", "Without discipline, no introspection or prescriptive statement is worthwhile. Firm control and influence over one's impulses and inclinations, in service of premeditated plans/ethics for wellbeing, is foundational to a civil and mature society"],
...
const valueConnections:ValueConnection[] = [
  new ValueConnection(["Transparency", "Introspection"], "Confidence is circumstantial, not a prerequisite", "Uncertainty is the default, and we go through life rummaging for evidence and patterns to provide sufficient/actionable certainty. Dogmatic confidence is a reckless opiate, an infantile substitute for exposing one's truths/capacity to the unknown and accepting that these may prove insufficient"),
  ...
  new ValueConnection(["Prudence", "Discipline"], "Don't be complicit in injustice", "It's one's moral duty to, in as many cases as viable and constructive, intervene when observing unjust acts/circumstances. The world becomes a better place when we proactively make it so, and it regresses when we lose that volition"),
  new ValueConnection(["Discipline", "Compassion"], "Be steadfast in your compassion", "As intoxicating as it may be to get swept-up in angst, irreverence, indignation, or zeal, none of these mentalities are well-suited for constructive conduct between people"),
];
