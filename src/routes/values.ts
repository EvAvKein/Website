...
const valueConnections:ValueConnection[] = [
  ...
  new ValueConnection(["Transparency", "Introspection"], "Voice your comprehension", "During conflict-resolution (whether interpersonal or technical), proactively voice realizations: This helps others form a more complete understanding of the problem, grants others opportunities to provide useful/complementary insights, and cultivates a culture where perspectives are not finalized or shackled by ego"),
  new ValueConnection(["Transparency", "Dicipline"], "Freely admit fault/inadequacy", "Every person goes through a different mix of circumstances in life, and we're all indefinitely work-in-progress. As long as you're courteous, act to the best of your ability, and readily defer/abstain when necessary, there's no shame in your imperfections"),
  new ValueConnection(["Transparency", "Compassion"], "Don't let transparency become verbosity", "Circumstances often don't permit the time/patience necessary for comprehensive, unambiguous transparency and the dialogue it's liable to prompt. Maintain the requisite social awareness to regulate one's transparency based on contextual consent, prioritizing explicit consent when provided/proper"),
  new ValueConnection(["Prudence", "Introspection"], "Mind your biases", "We're all vulnerable to biases, especially those who believe they're immune. Take the time to assess your judgements and assumptions for unsubstantiated, detrimental, or otherwise unchecked generalizations/distaste"),
  ...
  new ValueConnection(["Dicipline", "Compassion"], "Be steadfast in your compassion", "As intoxicating as it may get swept-up in angst, irreverence, indignation, or zeal, none of these mentalities are well-suited for constructive conduct between people"),
];
