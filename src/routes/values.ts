...
const valueConnections:ValueConnection[] = [
  new ValueConnection(["Transparency", "Introspection"], "Confidence is to be substantiated", "Uncertainty is the default, and we go through life rummaging for evidence and patterns to provide sufficient/actionable certainty. Dogmatic confidence is a reckless opiate, an infantile substitute for exposing one's truths/capacity to the unknown and accepting that these may prove insufficient"),
