...
const valueConnections:ValueConnection[] = [
  new ValueConnection(["Transparency", "Introspection"], "Confidence is circumstantial, not compulsory", "Uncertainty is the default, from which we rummage through life for evidence and patterns towards sufficient/actionable certainty. Dogmatic confidence is a reckless opiate, an infantile substitute for exposing one's truths/capacity to the unknown and accepting that these may prove insufficient"),
